...
@InjectionPoint.AtCode("FIELD_AFTER")
public class FieldAfterInjectionPoint extends BeforeFieldAccess {

    public FieldAfterInjectionPoint(final InjectionPointData data) {
        super(data);
    }
